...
const getNativeNodeBinding = (runtimePlatformArch) => {
  switch (runtimePlatformArch) {
    case `linux-x64`:
      return require("@hanzala-databrain/node-bindings-linux-x64/duckdb.node");
    case "linux-arm64":
      return require("@hanzala-databrain/node-bindings-linux-arm64/duckdb.node");
    case "darwin-arm64":
      return require("@hanzala-databrain/node-bindings-darwin-arm64/duckdb.node");
    case "darwin-x64":
      return require("@hanzala-databrain/node-bindings-darwin-x64/duckdb.node");
    case "win32-x64":
      return require("@hanzala-databrain/node-bindings-win32-x64/duckdb.node");
    default:
