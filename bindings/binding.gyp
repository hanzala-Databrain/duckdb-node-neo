                        ...
                        "copies": [
                            {
                                ...
                                "destination": "<(module_root_dir)/pkgs/@hanzala-databrain/node-bindings-linux-x64",
                            },
                        ],
                    },
                ],
                [
                    'OS=="linux" and target_arch=="arm64"',
                    {
                        ...
                        "copies": [
                            {
                                "files": ["<(module_root_dir)/libduckdb/libduckdb.so"],
                                "destination": "<(module_root_dir)/pkgs/@hanzala-databrain/node-bindings-linux-arm64",
                            },
                        ],
                    },
                ],
                [
                    'OS=="mac" and target_arch=="arm64"',
                    {
                        ...
                        "copies": [
                            {
                                "files": [
                                    "<(module_root_dir)/libduckdb/libduckdb.dylib"
                                ],
                                "destination": "<(module_root_dir)/pkgs/@hanzala-databrain/node-bindings-darwin-arm64",
                            },
                        ],
                    },
                ],
                        ...
                        "copies": [
                            {
                                ...
                                "destination": "<(module_root_dir)/pkgs/@hanzala-databrain/node-bindings-darwin-x64",
                            },
                        ],
                    },
                ],
                        ...
                        "copies": [
                            {
                                ...
                                "destination": "<(module_root_dir)/pkgs/@hanzala-databrain/node-bindings-win32-x64",
                            },
                        ],
                    },
                ],
                ...
                [
                    'OS=="linux" and target_arch=="x64"',
                    {
                        "copies": [
                            {
                                "files": [
                                    "<(module_root_dir)/build/Release/duckdb.node"
                                ],
                                "destination": "<(module_root_dir)/pkgs/@hanzala-databrain/node-bindings-linux-x64",
                            },
                        ],
